...
#else
  std::vector<StrId> enumValues = {StrId::STR_KOPUB_BATANG, StrId::STR_NOTO_SERIF, StrId::STR_NOTO_SANS,
  ...
  static const std::vector<SettingInfo> baseList = [] {
    std::vector<SettingInfo> v = {
        ...
        SettingInfo::Enum(StrId::STR_FONT_FAMILY, &CrossPointSettings::fontFamily,
                          {StrId::STR_KOPUB_BATANG, StrId::STR_NOTO_SERIF, StrId::STR_NOTO_SANS,
                           StrId::STR_OPEN_DYSLEXIC},
                          "fontFamily", StrId::STR_CAT_READER),
#endif
        ...
        SettingInfo::Toggle(StrId::STR_FIRST_LINE_INDENT, &CrossPointSettings::paragraphIndent, "paragraphIndent",
                            StrId::STR_CAT_READER),
