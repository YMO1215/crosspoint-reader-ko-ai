...
void EpubReaderActivity::renderContents(std::unique_ptr<Page> page, const int orientedMarginTop,
  ...
  const bool needsTextGrayscale = SETTINGS.textAntiAliasing && !heapStressed;
  const bool needsAnyGrayscale = !heapStressed && (needsTextGrayscale || pageHasImages);
  ...
  bool imagePageWithAA = pageHasImages && SETTINGS.textAntiAliasing && !heapStressed;
